 ...
 */
final class Version20220321155430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE trick SET slug=REPLACE(title, ' ', '-')");
        $this->addSql('ALTER TABLE trick MODIFY slug varchar(255) NOT NULL');

        $this->addSql('ALTER TABLE user ADD slug VARCHAR(255)');
        $this->addSql("UPDATE user SET slug=CONCAT('pseudo-', pseudo)");
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP slug, CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE chapo chapo VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');

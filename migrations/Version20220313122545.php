 ...
 */
final class Version20220313122545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE status_connected status_connected TINYINT(1) DEFAULT NULL, CHANGE validation_key validation_key VARCHAR(255) DEFAULT NULL, CHANGE activated_user activated_user TINYINT(1) DEFAULT NULL');
    }
